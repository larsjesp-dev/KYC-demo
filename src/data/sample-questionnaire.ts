          ...
          subgroups: [
            ...
            },
            {
              ...
              questions: [
                {
                  id: 'us-citizen',
                  text: 'Är du amerikansk medborgare? * (Läs mer om FATCA)',
                  type: 'radio',
                  required: true,
                  order: 1,
                  helpText: 'FATCA (Foreign Account Tax Compliance Act) kräver att amerikanska medborgare rapporterar utländska finansiella konton.',
                  options: [
                    {
                      id: 'yes-us-citizen',
                      label: 'Ja',
                      ...
                      followUpQuestions: [
                        {
                          id: 'us-tin',
                          text: 'Ange amerikanskt skatteregistreringsnummer (TIN)',
                          type: 'freetext',
                          required: true,
                          order: 1,
                          textConfig: {
                            placeholder: 'Exempel: 123-45-6789 eller 12-3456789'
                          }
                        }
                      ]
                    },
                ...
                },
                {
                  ...
                  text: 'Har du skatterättslig hemvist i något annat land än Sverige och USA? * (Läs mer om skatterättslig hemvist)',
                  type: 'radio',
                  required: true,
                  order: 2,
                  helpText: 'Skatterättslig hemvist avgör i vilket land du ska betala skatt på din inkomst och förmögenhet.',
                  options: [
                    {
                      id: 'yes-other-tax-residence',
                      label: 'Ja',
                      value: 'yes',
                      followUpQuestions: [
                        {
                          id: 'other-country-tin',
                          text: 'Ange land och utländskt(utländska) skatteregistreringsnummer (TIN)',
                          type: 'freetext',
                          required: true,
                          order: 1,
                          textConfig: {
                            placeholder: 'Exempel: Tyskland: 12345678901, Norge: 12345678901',
                            multiline: true
                          }
                        }
                      ]
                      ...
                      followUpQuestions: [
                        {
                          ...
                          options: [
                              ...
                              followUpQuestions: [
                                {
                                  ...
                                  order: 1,
                                  textConfig: {
                                    placeholder: 'Exempel: Minister, Ambassadör, Domare'
                                  }
                                },
                                {
                                  id: 'self-pep-country',
                                ...
                                },
                                {
                                  ...
                                  options: [
                                    ...
                                    { id: 'self-resigned-no', label: 'Nej', value: 'no' }
                                  ]
                                }
                              ]
                            },
                              ...
                              followUpQuestions: [
                                ...
                                },
                                {
                                  ...
                                  options: [
                                    ...
                                    { id: 'family-resigned-no', label: 'Nej', value: 'no' }
                                  ]
                                }
                              ]
                            },
                              ...
                              followUpQuestions: [
                                ...
                                },
                                {
                                  ...
                                  options: [
                                    ...
                                    { id: 'colleague-resigned-no', label: 'Nej', value: 'no' }
                                  ]
                                }
                              ]
                            },
                            {
                              id: 'both-pep',
                              label: 'Jag är själv en PEP och jag är familjemedlem till en PEP eller känd medarbetare till en PEP',
                              value: 'both-pep',
                              followUpQuestions: [
                                {
                                  id: 'both-self-title',
                                ...
                                {
                                  id: 'both-pep-resigned',
                                  text: 'Har trätt ur PEP-ställningen?',
                                  type: 'radio',
                                  required: true,
                                  order: 5,
                                  options: [
                                    { id: 'both-resigned-yes', label: 'Ja', value: 'yes' },
                                    { id: 'both-resigned-no', label: 'Nej', value: 'no' }
                                  ]
                                }
                              ]
                            }
          ...
          subgroups: [
            ...
            },
            {
              ...
              questions: [
                ...
                {
                  id: 'cash-withdrawals',
                  text: 'Hur mycket kommer du ta ut i kontanter i Sverige per år?',
                  type: 'radio',
                  required: true,
                  order: 2,
                  options: [
                    { id: '0-20000', label: '0 - 20 000 SEK', value: '0-20000' },
                    { id: '20001-50000', label: '20 001 – 50 000 SEK', value: '20001-50000' },
                    { id: '50001-70000', label: '50 001 – 70 000 SEK', value: '50001-70000' },
                    { id: 'over-70000', label: 'Över 70 000 SEK', value: 'over-70000' }
                  ]
                },
                {
            ...
            {
              id: 'consumer-creditcard-account',
              title: 'Kontodetaljer och användning',
              order: 3,
              questions: [
                {
              ...
              questions: [
                {
                  ...
                  options: [
                    ...
                    { 
                      ...
                      followUpQuestions: [
                        {
                          id: 'loan-purpose-other-specify',
                          text: 'Specificera vad lånet ska användas till:',
                          type: 'dropdown-multiple',
                          required: true,
                          order: 1,
                          options: [
